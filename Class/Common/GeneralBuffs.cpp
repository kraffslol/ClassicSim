    ...
    current_setup(0)
{
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        this->external_buffs[i].append(QPair<bool, ExternalBuff*>(false, get_external_buff_by_name(ExternalBuffName::ElementalSharpeningStone, pchar)));
        ...
        this->external_buffs[i].append(QPair<bool, ExternalBuff*>(false, get_external_buff_by_name(ExternalBuffName::BrilliantWizardOil, pchar)));
