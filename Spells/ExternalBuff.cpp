...
void ExternalBuff::buff_effect_when_applied() {
    ...
    case ExternalBuffName::BattleSquawk:
        ...
        break;
    case ExternalBuffName::BrilliantWizardOil:
        pchar->get_stats()->increase_base_spell_damage(36);
        pchar->get_stats()->increase_spell_crit(100);
        break;
    case ExternalBuffName::ElementalSharpeningStone:
        pchar->get_stats()->increase_melee_crit(200);
        break;
...
ExternalBuff* get_external_buff_by_name(const ExternalBuffName name, Character* pchar) {
    ...
    case ExternalBuffName::BrilliantWizardOil:
        return new ExternalBuff(pchar, "Brilliant Wizard Oil", BuffDuration::PERMANENT, 0,
                                name, AvailableFactions::Neutral, "Assets/spell/Spell_holy_lesserheal02.png",
                                "36 Spell Damage 1% Spell Crit");
    case ExternalBuffName::ElementalSharpeningStone:
        return new ExternalBuff(pchar, "Elemental Sharpening Stone", BuffDuration::PERMANENT, 0,
                                name, AvailableFactions::Neutral, "Assets/items/Inv_stone_02.png",
                                "2% Crit");
    case ExternalBuffName::GreaterArcaneElixir:
